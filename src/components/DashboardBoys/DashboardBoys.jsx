...
const [hasBike, setHasBike] = useState(false);
          ...
          <form className="row g-3" onSubmit={handleBoysRoomsSubmit}>
            ...
            <div className="col-md-6">
              ...
              <select className="form-select" id="inputRole" name="role" value={createdBy} onChange={(e) => setCreatedBy(e.target.value)}>
                <option value="admin">{t('dasboard.admin')}</option>
            ...
            {showForm ?
              <div className='monthlyAddForm'>
                <form class="row lg-10" onSubmit={handleRentSubmit}>
                  ...
                  <div class="col-md-6 mb-3">
                    <label htmlFor="PaidAmount" class="form-label">{t('dahboard.paidAmount')}</label>
            ...
            <div class="col-md-6">
              ...
              {isEditing && tenantIdUrl && (
                <object
                  ...
                  height="200px"
                >
                  <a href={tenantIdUrl}>{t('Download PDF')}</a>
                </object>
              )}
  ...
  <label className='col-sm-12 col-md-4' htmlFor="bikeCheck">{t('Do you have a bike?')}</label>
  <input
    type="radio"
    className="Radio"
    id="bikeCheck"
    ...
    checked={hasBike}
  />
  <label htmlFor='bikeCheck' className='bike'>{t('Yes')}</label>
  <input
    type="radio"
    id="bikeCheck1"
    name="bike"
  ...
  />
  <label htmlFor='bikeCheck1' className='bike'>{t('No')}</label>
</div>

{hasBike ? (
                    <div className='bikeField' style={{ display: 'flex', flexDirection: 'row', marginTop: '10px' }}>
                      <label class="bikenumber" htmlFor="bikeNumber" >{t('Bike Number:')}</label>
                      <input
                        type="text"
                        id="bikeNumber"
            ...
            <div className='col-12 text-center'>
              {isEditing ? (
                <button type="button" className="btn btn-warning" onClick={handleTenantSubmit}>{t('Update Tenant')}</button>
              ) : (
                <button className='btn btn-warning' type="submit">{t('Add Tenant')}</button>
              )}
            </div>
          </form>
        )
      ...
      case "Add Expenses":
        return (
          <form className="row 1g-10" onSubmit={expensesHandleSubmit}>
            <div className="col-md-6">
              <label htmlFor="inputExpenseName" className="form-label">{t('Expense Name')}</label>
            ...
            <div className="col-md-6">
              <label htmlFor="inputRent" className="form-label">{t('Expense amount')}</label>
            ...
            <div className="col-md-6">
              <label htmlFor="inputDate" className="form-label">{t('Expense Date')}</label>
            ...
            <div className="col-12 text-center mt-3">
              <button type="submit" className="btn btn-warning">{t('Create')}</button>
            </div>
          </form>
  ...
  return (
    <div className="dashboardboys">
      <h1 className="heading">{t("Men's")}</h1>
      <div className="menu">
        {menu.map((item, index) => (
      ...
      {popupOpen &&
        <div className="popupBeds" id="example">
          <Button variant="primary" onClick={() => setPopupOpen(true)}>{t('Open Popup')}</Button>
          <Modal show={popupOpen} onHide={onClickCloseBedsPopup} dialogClassName="modal-90w">
            <Modal.Header closeButton>
              <Modal.Title>{t('Unoccupied Beds')}</Modal.Title>
            </Modal.Header>
